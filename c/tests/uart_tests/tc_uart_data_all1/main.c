/*
 * TF_UART_012 — All-ones data byte
 * Sends 0xFF and verifies loopback returns 0xFF.
 */
...
int main(void)
{
    ...
    printf("INFO: TF_UART_012: Send 0xFF, verify loopback\n");
    ...
    *thr = tx_byte;
    ...
    if (rx_byte == tx_byte) {
        ...
        printf("INFO: FAIL: TX 0x%02X, RX 0x%02X (expected 0xFF)\n", tx_byte, rx_byte);
    }
